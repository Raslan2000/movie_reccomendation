...
if __name__ == "__main__":
    ...
    train_arr, test_arr, num_users, num_movies, _ = data_transformation.initiate_data_transformation(train_data, test_data)
    modeltrainer = ModelTrainer()
    print(modeltrainer.initiate_model_trainer(train_arr, test_arr, num_users, num_movies))